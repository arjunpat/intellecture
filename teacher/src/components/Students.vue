  ...
  <v-row align="center" justify="center">
      ...
      <v-row align="center" justify="center" v-if="students.length != 0 || showTutorial == 6">
          ...
          <ul style="list-style-type: none">
              ...
              <v-banner style="font-family: var(--main-font);">
                ...
                >
                  ...
                  <transition name="fade">
                    <v-btn v-if="hover" class="ml-3" text color="red" @click="() => {invertDialog(); setActive(student)}" @close="invertDialog">Remove</v-btn> 
                  </transition>
                  </span>
                </v-hover>
            ...
            <!-- EXAMPLE QUESTION -->
            <TutorialDisplay :show="showTutorial == 6" backgroundColor="white" @next="nextTutorial(); clickTab(0)" @cancel="resetTutorial()" bottom>
